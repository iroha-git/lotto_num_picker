...
if __name__ == "__main__":
    append_new_pick()
    print(random_pick())  # 6개의 무작위 번호
    print(most_picked_num(random_from_rank=10))  # 가장 많이 나온 숫자 10위 이하의 임의의 6개 번호
    print(most_picked_num(reverse=True, random_from_rank=10))  # 뒤에서 10위 까지의 임의의 6개 번호
    print(predict_with_xgboost())  # 머신러닝을 통한 많이 나올법한 6개 번호 예측
    print(predict_with_xgboost(reverse=True))  # 머신러닝을 통한 가장 안나올법한 6개 번호 예측
    exit()
